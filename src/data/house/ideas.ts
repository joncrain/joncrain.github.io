...
export const boards: ProjectBoard[] = [
	{
		...
		photos: [
			...
			{
				id: "existing-angle-top",
				src: "/house/ideas/backyard/existing-angle-top.jpg",
				caption: "Top angle view of the rear yard.",
				section: "existing",
				sort: 4,
			},
			{
			...
			{
				id: "existing-side-06",
				src: "/house/ideas/backyard/existing-side-06.jpg",
				caption: "Side yard — another angle.",
				section: "existing",
				sort: 9,
			},
			{
			...
			},
			{
				...
				caption: "Concept — overhead example.",
				section: "concepts",
				sort: 2,
			},
			{
