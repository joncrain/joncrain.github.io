...
description: 'Using Munki to control UAMDM profiles via the MicroMDM API, leveraging existing manifest groups for profile management.'
pubDate: '2018-11-01'
tags: ['macOS', 'MicroMDM', 'Munki']
---

### _Checkout out [Part II](/blog/munkimdm-part-2/) for actual Middleware! And [Part III](/blog/munkimdm-part-3/) to really extend it!_
