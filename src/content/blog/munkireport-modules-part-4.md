...
description: 'Gathering data for MunkiReport modules using osquery and understanding the client-side script deployment process.'
pubDate: '2018-12-06'
...
If you have followed [Part 1](/blog/munkireport-modules-part-1/), you should have your module loaded into your development site after running this command:
