...
description: 'Extending the MicroMDM middleware with basic authentication and parameterized commands for broader MDM control.'
pubDate: '2018-11-08'
tags: ['macOS', 'MicroMDM', 'Munki']
---

Check out [Part I](/blog/munkimdm-part-1/) & [Part II](/blog/munkimdm-part-2/) for more info on the background and progress to this point.
