...
description: 'Presenting MunkiReport module data with the listing view, including i18n, column configuration, and formatters.'
pubDate: '2019-08-24'
...
Now in [Part 2](/blog/munkireport-modules-part-2/), we looked at a basic overview of the different views available. In this section we will dive deeper into how to work with the listing view.
...
![final_listing](/images/final_listing.png)
