...
description: 'Complete overview of the Munki + MicroMDM workflow for controlling UAMDM profiles with Munki manifest logic.'
pubDate: '2019-01-29'
...
2. Add a `preinstall_script` and an `uninstall_script`
   * The preinstall does the actual installing of the profile, essentially calling the [middleware](/blog/munkimdm-part-1/) and adding the profile from the Munki cache as it's payload.
